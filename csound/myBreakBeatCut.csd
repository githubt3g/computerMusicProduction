...
;SET INITIAL VALUES FOR SLIDERS 	|VALUE | HANDLE
			...
			FLsetVal_i	1, 	ihFltMix
			FLsetVal_i	10, 	ihbw
			FLsetVal_i	1, 	ihi_h
			FLsetVal_i	2, 	ihfltdiv
...
instr	1	
	...
	gasigL  =	amixL				;SEND AUDIO TO OUTPUTS
    gasigR  =   amixR				;SEND AUDIO TO OUTPUTS
endin
